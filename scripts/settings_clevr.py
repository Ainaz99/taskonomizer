...
RGB_MODEL_FILE = "segmented.obj"      # delete ?
...
SENSOR_HEIGHT = 18                      #18:clevr , 20:all
SENSOR_WIDTH = 32                       #32:clevr , 20:all
TILE_SIZE = 128
...
BUILDING=True
MAX_CAMERA_ROLL = 2        # in degrees

# camera sampling in the building
MIN_CAMERA_DISTANCE = 50   # in meters
MIN_CAMERA_HEIGHT = 50       # in meters
MAX_CAMERA_HEIGHT = 250       # in meters
MIN_CAMERA_DISTANCE_TO_MESH = 30  # in meters

FLOOR_THICKNESS = 25      # in meters
FLOOR_HEIGHT = 200            # in meters
...
DEPTH_ZBUFFER_MAX_DISTANCE_METERS = 64    #64:clevr , 128:all, 0.5:google_scanned  
# With 128m and 16-bit channel, has sensitivity 1/512m (128 / 2^16)
DEPTH_EUCLIDEAN_MAX_DISTANCE_METERS = 64  #64:clevr , 128:all, 0.5:google_scanned  

# -----Curvature------
MIN_CURVATURE_RADIUS = 0.06           #0.06:clevr , 0.03:all  # in meters
...
CANNY_RGB_BLUR_SIGMA = 1.0              # 1.0:clevr, 1.0:google_scanned, 1.0:carla, 3.0:all
...
KEYPOINT_SUPPORT_SIZE = 0.3     #0.3:all , 0.3:clevr, 0.005:google_scanned, 1.0:carla

# Applies a blur after keypoint detection, radius
KEYPOINT_BLUR_RADIUS = 5

# ----Reshading-----
LAMP_ENERGY = 10                 #2.5:all , 10:clevr, 1.5:google_scanned, 800:hypersim
...
# ----Field of view----
FIELD_OF_VIEW_MIN_RADS = math.radians(70)
FIELD_OF_VIEW_MAX_RADS = math.radians(100)
