...
# blender -b --enable-autoexec -noaudio --python $SCRIPT_PATH/create_semantic_images_clevr.py -- \
...
docker run --rm -v $current_path:/app/ \
                ...
                "blender -b --enable-autoexec -noaudio --python /app/scripts/create_semantic_images_clevr.py \
